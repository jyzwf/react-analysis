...
function isValidContainer(node) {
  return !!(
    node &&
    (node.nodeType === ELEMENT_NODE ||  // 代表元素
      node.nodeType === DOCUMENT_NODE ||  // 代表整个文档（DOM 树的根节点）
      node.nodeType === DOCUMENT_FRAGMENT_NODE || // 代表轻量级的 Document 对象，能够容纳文档的某个部分
      (node.nodeType === COMMENT_NODE &&  // 代表注释
